...
class EndianBinaryReader:
    ...
    BaseOffset: int
    Encryption: Callable
    def __new__(cls, item: Union[bytes, bytearray, memoryview, BytesIO, str], endian: str = ..., offset: int = ..., size: int = ..., encrypt_func: Callable | None = ...): ...
    def __init__(self, item, endian: str = ..., offset: int = ..., size: int = ..., encrypt_func: Callable = ...) -> None: ...
...
class EndianBinaryReader_Memoryview(EndianBinaryReader):
    view: memoryview
    endian: str
    def __init__(self, view: memoryview, endian: str = ..., offset: int = ..., size: int | None = ..., encrypt_func: Callable = ...) -> None: ...
    @property
...
class EndianBinaryReader_Streamable(EndianBinaryReader):
    stream: IOBase
    endian: str
    def __init__(self, stream: IOBase, endian: str = ..., offset: int = ..., size: int = ..., encrypt_func: Callable = ...) -> None: ...
